...
func OaiStreamHandler(c *gin.Context, info *relaycommon.RelayInfo, resp *http.Response) (*dto.Usage, *types.NewAPIError) {
	...
	if streamErr := terminalOpenRouterStreamError(info, lastStreamData); streamErr != nil {
		switch info.RelayFormat {
		case types.RelayFormatClaude:
			_ = helper.ClaudeData(c, dto.ClaudeResponse{
				Type: "error",
				Error: types.ClaudeError{
					Type:    streamErr.ClaudeType,
		...
		return nil, types.NewErrorWithStatusCode(
			errors.New(streamErr.Message),
			types.ErrorCodeBadResponseStatusCode,
			streamErr.StatusCode,
...
func terminalOpenRouterStreamError(info *relaycommon.RelayInfo, data string) *openRouterStreamError {
	...
	return parseOpenRouterStreamError(envelope)
}
...
func OpenaiHandler(c *gin.Context, info *relaycommon.RelayInfo, resp *http.Response) (*dto.Usage, *types.NewAPIError) {
	...
	if isOpenRouterRelay(info) && info.ChannelOtherSettings.IsOpenRouterEnterprise() {
	...
	if isOpenRouterRelay(info) {
		simpleResponse.Id = helper.GetResponseID(c)
