...
func UpdateSelf(c *gin.Context) {
	...
	// Self-service profile updates are deliberately allow-listed. Identity,
	// authorization, billing, and account-state fields remain server-controlled.
