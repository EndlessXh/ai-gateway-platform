...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		platformModelRoute := apiRouter.Group("/platform/models")
		platformModelRoute.Use(middleware.TryUserAuth())
		{
			platformModelRoute.GET("", controller.ListPublicPlatformModels)
			platformModelRoute.GET("/:public_model_id", controller.GetPublicPlatformModel)
		}
		platformModelAdminRoute := apiRouter.Group("/platform/admin/models")
		platformModelAdminRoute.Use(middleware.AdminAuth())
		{
			platformModelAdminRoute.GET("", controller.AdminListPlatformModels)
			platformModelAdminRoute.GET("/diagnostics", controller.AdminListPlatformModels)
			platformModelAdminRoute.GET("/:id", controller.AdminGetPlatformModel)
			platformModelAdminRoute.POST("", controller.AdminCreatePlatformModel)
			platformModelAdminRoute.PUT("/:id", controller.AdminUpdatePlatformModel)
			platformModelAdminRoute.PATCH("/:id/api-enabled", controller.AdminSetPlatformModelAPIEnabled)
			platformModelAdminRoute.DELETE("/:id", controller.AdminArchivePlatformModel)
		}
		platformPlanRoute := apiRouter.Group("/platform/plans")
		{
			platformPlanRoute.GET("", controller.ListPublicPlatformSubscriptionPlans)
			platformPlanRoute.GET("/:plan_key", controller.GetPublicPlatformSubscriptionPlan)
		}
		platformSubscriptionRoute := apiRouter.Group("/platform/subscriptions")
		platformSubscriptionRoute.Use(middleware.UserAuth())
		{
			platformSubscriptionRoute.GET("/current", controller.GetCurrentPlatformSubscriptions)
			platformSubscriptionRoute.GET("/history", controller.GetPlatformSubscriptionHistory)
			platformSubscriptionRoute.GET("/:id/events", controller.GetPlatformSubscriptionEvents)
			platformSubscriptionRoute.POST("/purchase", middleware.CriticalRateLimit(), controller.PurchasePlatformSubscription)
			platformSubscriptionRoute.POST("/:id/cancel", middleware.CriticalRateLimit(), controller.CancelPlatformSubscription)
			platformSubscriptionRoute.POST("/:id/cancel/revoke", middleware.CriticalRateLimit(), controller.RevokePlatformSubscription)
			platformSubscriptionRoute.PUT("/:id/auto-renew", middleware.CriticalRateLimit(), controller.SetPlatformSubscriptionAutoRenew)
			platformSubscriptionRoute.POST("/:id/renew", middleware.CriticalRateLimit(), controller.RenewPlatformSubscription)
		}
		platformSubscriptionAdminRoute := apiRouter.Group("/platform/admin/subscriptions")
		platformSubscriptionAdminRoute.Use(middleware.AdminAuth())
		{
			platformSubscriptionAdminRoute.GET("/plans", controller.AdminListPlatformSubscriptionPlans)
			platformSubscriptionAdminRoute.GET("/plans/:id", controller.AdminGetPlatformSubscriptionPlan)
			platformSubscriptionAdminRoute.POST("/plans", controller.AdminCreatePlatformSubscriptionPlan)
			platformSubscriptionAdminRoute.PUT("/plans/:id", controller.AdminUpdatePlatformSubscriptionPlan)
			platformSubscriptionAdminRoute.DELETE("/plans/:id", controller.AdminArchivePlatformSubscriptionPlan)
			platformSubscriptionAdminRoute.GET("", controller.AdminListPlatformSubscriptions)
			platformSubscriptionAdminRoute.POST("/reconcile", controller.AdminReconcilePlatformSubscriptions)
			platformSubscriptionAdminRoute.GET("/:id", controller.AdminGetPlatformSubscription)
			platformSubscriptionAdminRoute.POST("/:id/cancel", controller.AdminCancelPlatformSubscription)
			platformSubscriptionAdminRoute.POST("/:id/renew", controller.AdminRenewPlatformSubscription)
		}
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.POST("/sessions/revoke-all", middleware.DisableCache(), controller.RevokeAllLoginSessions)
