...
// InitDB initializes the primary database connection and applies pending
// migrations. Long-running application processes use this startup path.
func InitDB() error {
	return initDB(true)
}

// InitDBWithoutMigration initializes the primary database connection without
// changing schema or data. It is intended for read-only operational tools that
// must inspect an already-provisioned database without turning a dry-run into a
// migration attempt.
...
func migrateDB() error {
	...
	err := DB.AutoMigrate(
		...
		&PlatformSubscriptionPlanProfile{},
...
func migrateDBFast() error {
	...
	migrations := []struct {
		...
		{&Task{}, "Task"},
		{&Model{}, "Model"},
		{&PlatformModelCatalog{}, "PlatformModelCatalog"},
		{&PlatformSubscriptionPlanProfile{}, "PlatformSubscriptionPlanProfile"},
		{&PlatformSubscriptionLifecycle{}, "PlatformSubscriptionLifecycle"},
		{&PlatformSubscriptionEvent{}, "PlatformSubscriptionEvent"},
		{&PlatformSubscriptionRequest{}, "PlatformSubscriptionRequest"},
		{&Vendor{}, "Vendor"},
