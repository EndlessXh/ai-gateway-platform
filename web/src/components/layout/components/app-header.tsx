...
export function AppHeader({
  ...
  const currentSection = pathname.split('/').at(-1) || 'dashboard'
  ...
  return (
    <Header>
      ...
      <span aria-hidden='true' className='text-border hidden md:inline'>
        /
      </span>
      <span
        aria-current='page'
        className='text-muted-foreground hidden max-w-40 truncate text-xs md:inline'
      >
        {t(currentLabel)}
      </span>
