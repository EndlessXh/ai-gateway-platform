...
export const STATIC_I18N_KEYS = [
  ...
  'Messages-compatible',
  'API request example',
  'Neutral platform model aliases',
  'Verified platform surface',
  'Infrastructure features that stay observable',
  ...
  'Streaming responses',
  'SSE streaming has been exercised against the current development upstream.',
  'Scoped API tokens',
  ...
  'The architecture supports additional channel adapters; availability depends on configured upstreams.',
  'Request path',
  'From token creation to an auditable request',
  'Create a token',
  'Set model access, quota, and expiry before sharing a key.',
  'Choose a platform alias',
  'Integrate with a stable, neutral model name instead of an upstream-specific identifier.',
  'Send a compatible request',
  'Use the documented chat or messages route, with streaming when the workflow needs it.',
  'Inspect usage',
  'Review request logs and quota movement from the authenticated console.',
  'Developer access',
  'Continue from the console',
  'Start with a scoped API token',
  ...
  'Navigation menu',
  'Route not found',
  'This page is not part of the gateway.',
  'The address may be outdated or the page may have moved. Use a known route to continue.',
  'Permission required',
  'Your account cannot access this resource.',
  'Return to the dashboard or ask an administrator to review your role and permissions.',
  'Authentication required',
  'Sign in to continue.',
  'Your session may have expired, or this route requires an authenticated account.',
  'Service unavailable',
  'The gateway is temporarily unavailable.',
  'Wait a moment and retry. If the problem continues, use the documentation link for support information.',
  ...
  // Phase 5B wallet, profile and login-session surfaces
  ...
  'Account status',
  'API request',
  'Available credit in the account ledger',
  'Avatar is generated from your account identity; custom uploads are not supported.',
  'Basic profile',
  'Billing history',
  'Billing information',
  'Configured rate applied',
  'Credit / remaining quota',
  'Current allowance available for API requests',
  ...
  'Single available value from the account credit ledger',
  ...
  'Temporarily unavailable — retry to refresh.',
  'Today consumption unavailable',
  ...
  'No product lifecycle records',
  'No product subscription plans',
  'No subscription events',
  'One renewal attempt is made at the period boundary.',
  'Open Wallet',
  'Period start',
  'Plan key',
  'Plan price is sourced from the subscription plan record.',
  ...
  'Recent product subscriptions and entitlement truth.',
  'Reconcile',
  'Renew',
  'Renew now',
  'Renewable',
