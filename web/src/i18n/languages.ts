...
/** Select administrator-authored operational copy without scattering locale
 * conditionals through product surfaces. */
export function selectOperationalText(
  locale: string | null | undefined,
  copy: { en: string; zhCN: string }
): string {
  return normalizeInterfaceLanguage(locale) === 'zhCN' ? copy.zhCN : copy.en
}
