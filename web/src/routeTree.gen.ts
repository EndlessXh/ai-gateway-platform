...
import { Route as ModelCatalogIndexRouteImport } from './routes/model-catalog/index'
...
const ModelCatalogIndexRoute = ModelCatalogIndexRouteImport.update({
  id: '/model-catalog/',
  path: '/model-catalog/',
  getParentRoute: () => rootRouteImport,
} as any)
...
export interface FileRoutesByFullPath {
  ...
  '/model-catalog/': typeof ModelCatalogIndexRoute
...
export interface RootRouteChildren {
  ...
  ModelCatalogIndexRoute: typeof ModelCatalogIndexRoute
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/model-catalog/': {
      ...
      preLoaderRoute: typeof ModelCatalogIndexRouteImport
      parentRoute: typeof rootRouteImport
    }
    '/oauth/$provider': {
      id: '/oauth/$provider'
...
const rootRouteChildren: RootRouteChildren = {
  ...
  ModelCatalogIndexRoute: ModelCatalogIndexRoute,
