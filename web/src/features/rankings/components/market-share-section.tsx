...
export function MarketShareSection(props: MarketShareSectionProps) {
  ...
  const spec = useMemo(() => {
    ...
    return {
      ...
      stack: true,
      paddingInner: 0.12,
      // Same low-cardinality cap as the models chart: two days of history
      // otherwise produce two full-height slabs. Presentation only.
      barMaxWidth: 64,
  ...
  const [left, right] = splitIntoColumns(visible)
