...
import { CatalogAdmin } from '@/features/model-catalog/admin/catalog-admin'
...
const SECTION_META: Record<ModelsSectionId, { titleKey: string }> = {
  catalog: {
    titleKey: 'Product model catalog',
  },
  metadata: {
    titleKey: 'Metadata',
  },
...
function ModelsContent() {
  ...
  if (activeSection === 'metadata') {
    sectionAction = <ModelsPrimaryButtons />
  ...
  return (
    <>
      <SectionPageLayout fixedContent>
        ...
        <SectionPageLayout.Actions>{sectionAction}</SectionPageLayout.Actions>
