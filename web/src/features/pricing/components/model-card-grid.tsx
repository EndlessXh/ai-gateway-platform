...
import { resultGridClass } from '@/components/public/result-grid'
...
export function ModelCardGrid(props: ModelCardGridProps) {
  ...
  return (
    <div className='space-y-4 sm:space-y-5'>
      {/* Columns follow the number of cards on this page; see resultGridClass. */}
      <div className={resultGridClass(pagedModels.length)}>
